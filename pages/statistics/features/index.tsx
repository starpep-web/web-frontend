...
import { DatabaseFeaturesStatistics } from '@lib/models/statistics';
import { getDatabaseFeaturesStatistics } from '@lib/services/graphDb/statisticsService';
import uniqolor from 'uniqolor';

interface ServerSideProps {
  statistics: DatabaseFeaturesStatistics
}
...
const FeaturesStatisticsPage: React.FC<Props> = ({ statistics }) => {
...
export const getServerSideProps = async (): Promise<GetServerSidePropsResult<ServerSideProps>> => {
  const statistics = await getDatabaseFeaturesStatistics();
