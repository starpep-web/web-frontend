  ...
  return (
    <Block>
      <Notification color="info">
        ...
        Each filter will be evaluated sequentially, <span className="is-underlined">there is no precedence of <strong>AND</strong> over <strong>OR</strong> operators.</span>
      </Notification>
    </Block>
  );
};
